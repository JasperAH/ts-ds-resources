...
public class TestMeasurementsExporter {
    ...
    public void testJSONArrayMeasurementsExporter() throws IOException {
        ...
        assertEquals(json.get(0).get("measurement").asText(), "OneMeasurementHistogram");
        assertEquals(json.get(4).get("measurement").asText(), "MinLatency(us)");
        assertEquals(json.get(11).get("measurement").asText(), "999thPercentileLatency(us)");
    }
}
